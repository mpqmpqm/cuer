...
export const BOX: [number, number, number] = [3, 6, 5]; // Width, Height, Depth
export const SECTIONS: [number, number, number] = [4, 6, 4]; // X, Y, Z sections
